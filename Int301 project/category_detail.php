...
$result = mysql_query("SELECT * FROM `movies` WHERE `movieID` in (select `movieID` from `mcate` where `caID` = $cID)");
...
while($row = mysql_fetch_array($result))
 {
  ...
  echo '<a href="#" title="pic"><img id="1" src="images/rankings/'.$row['movieID'].'.jpg" width="100px" height="150px" alt="movie pic"/></a>';
  echo "</td>";
  echo '<td valign="top">
              <div class="mcontent">';
